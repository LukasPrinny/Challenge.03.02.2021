...
Les sessions de formation au métier d’intégrateur / intégratrice seront dispensées en téléprésentiel par les formateurs et formatrices de l’entreprise [Tanaguru](https://www.tanaguru.com/) et de l’école [O’clock](https://oclock.io/).
...
Pour les personnes sourdes et malentendantes, un dispositif de sous-titrage en temps réel et/ou d’interprétation en Langue des Signes Française (LSF) sera mis en place.

Vous trouverez ci-dessous le programme de la formation de 595 heures (4 mois).

 [Découvrez le programme ci-dessous !](https://www.integra11y.fr/programme.php) 
...
À l’issue de la formation de 4 mois, vous vous lancerez dans la recherche d’un stage en entreprise, obligatoire, de 2 mois. Pour cela, notre chargée de placement, secondée par Pôle Emploi et l’Agefiph vous accompagnera.
...
- Passage d'un oral devant un jury de professionnels
  ...
  [Voir les détails sur la certification](https://www.francecompetences.fr/recherche/rncp/31114/)

  ## La certification Opquast

  La certification [Opquast](https://www.opquast.com/) est une certification de qualité web. Reconnue dans le secteur, elle permet de valider les compétences des professionnels et professionnelles du web (commerciaux, commerciales, designers, développeurs, développeuses, etc.) en matière de qualité.
...
Il est obligatoire d’être demandeur ou demandeuse d’emploi résidant en Île-de-France pour accéder à la formation.

Cette formation est spécifiquement conçue pour les personnes handicapées et elles sont donc prioritaires lors du processus de sélection.

D’autres publics peuvent accéder à la formation, sous réserve de validation de certains critères lors du processus d’inscription et de places suffisantes :

- personnes de bas niveau de qualification (bac et moins)
- bénéficiaires du RSA
- résidents et résidentes des quartiers prioritaires en politique de la ville
- personnes justifiant de difficultés dans leur insertion professionnelle.

Il est essentiel de bien maîtriser les outils informatiques pour suivre cette formation.

### Où a lieu la formation ?

Vous suivez la formation depuis votre domicile, en téléprésentiel, grâce à nos [classes virtuelles](https://www.integra11y.fr/classe-virtuelle.php) adaptées aux besoins de chacun. Les formateurs et formatrices animent les cours en temps réel.
